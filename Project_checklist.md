Project Checklist before adding API KEY
- [x] Test on ASCII generator 
- [x] Check the bot, if it will run on the background after booting up or restarting the device 
- [x] check if it will update github repo push with time-stamp messages 
- [x] Light and Dark themed SVGs generated
- [x] Check for Vulnerabilities 
- [x] Check if the SVG stat has Lines of Codes similar to `example.svg` 
- [x] No need to add bot details on README.md file, only the picture (svg)
- [x] Details of the bot can be added in a separate file `bot/README.md` and linked to the main README.md file
